...
let All_song = [
   {
     name: "Colours",
     path: "./songs/Colours - Kwesi Arthur.m4a",
     img: "./img/C.jpg",
     singer: "Kwesi Arthur"
   },
   {
     name: "Drama",
     path: "./songs/1. Drama - Kwesi Arthur  Bigg Homie Flee (320).mp3",
     img: "./img/SOJ.jpeg",
     singer: "Kwesi Arthur"
   },
   {
     name: "Celebrate",
     path: "./songs/4_5836778096186894594.mp3",
     img: "./img/SOJ.jpeg",
     singer: "Kwesi Arthur"
   },
   {
     name: "Silver Spoon",
     path: "./songs/Adom - Kwesi Arthur (320) (2).mp3",
     img: "./img/SOJ.jpeg",
     singer: "Kwesi Arthur"
   },
   {
     name: "Disturb",
     path: "./songs/Adom - Kwesi Arthur (320).mp3",
     img: "./img/SOJ.jpeg",
     singer: "Kwesi Arthur"
   },
   {
	name: "Winning",
	path: "./songs/Winning ft Vic Mensa[@music4Syte].mp3",
	img: "./img/SOJ.jpeg",
	singer: "Kwesi Arthur"
  }
];
